                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('admin.accounts.update',['id'=>$account->id])}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="username" type="text" disabled class="form-control" value="{{$account->username}}">
                                            ...
                                            <div class="form-group">
                                                <label>Địa chỉ</label>
                                                <input  name="diachi" type="text" class="form-control cc-name valid" value="{{$account->tenkh}}">
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input name="email" type="email" class="form-control" value="{{$account->username}}">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                <label>Loại tk</label>
                                                <input  name="loaitk" type="tel" class="form-control" value="{{$account->password}}">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                <label>Trạng thái</label>
                                                <input  name="trangthai" type="tel" class="form-control" value="{{$account->password}}">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
